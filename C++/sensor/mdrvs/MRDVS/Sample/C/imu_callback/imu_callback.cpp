...
int main(int argc, char** argv)
{
    ...
    //设置IMU量程
    DcSetIntValue(handle, LX_INT_IMU_ACCELERATION_LEVEL, 4);
    DcSetIntValue(handle, LX_INT_IMU_ANGULAR_RANGE_LEVEL, 4);
    //启动IMU
    ...
    wait_key = getchar();
    DcSetBoolValue(handle, LX_BOOL_ENABLE_IMU, false);
