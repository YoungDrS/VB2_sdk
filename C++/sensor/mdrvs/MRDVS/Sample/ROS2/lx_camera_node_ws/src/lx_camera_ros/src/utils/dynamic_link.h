...
struct DcLib {
  ...
  LX_STATE (*DcGetCameraCalibParams)(DcHandle, LX_IMAGE_TYPE,
                                     LxCameraCalibrationParameters *);
  ...
  LX_STATE (*DcStartIMU)(DcHandle, uint16_t, uint16_t);
  LX_STATE (*DcStopImu)(DcHandle);
};
...
#define DcGetCameraCalibParams(A, B, C)                                     \
  (*LX_DYNAMIC_LIB->DcGetCameraCalibParams)(A, B, C)
