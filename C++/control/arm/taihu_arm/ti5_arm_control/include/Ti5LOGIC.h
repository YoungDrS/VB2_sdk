...
{ // 添加extern "C"
	...
	protected:
		...
		void init_arm_structure()
		{
			...
			rod[0].r = 10, rod[1].r = 10, rod[2].r = 10;	// 擎朗连杆半径
			rod[0].l = 171, rod[1].l = 260, rod[2].l = 259; // 擎朗连杆长度
			init_rodindex();
		}
		// 初始化数学模型参数
	...
	public:
		...
		// bool r_backward_move(float postrue[6]);//2025-4-11更新
		bool r_backward_move(float r_pos[6]);
		void show_crt_pos();
		void show_crt_j();
		void showpointsinfo();
	};
