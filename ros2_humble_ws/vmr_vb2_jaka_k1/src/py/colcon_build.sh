...
# 定义工作空间路径
WORKSPACE_DIR="/home/jing/lanxin/ros2_test/ws_vb2_jaka"
...
# 先编译接口包
echo "Step 1: Building interfaces (lx_motor_interfaces, service_srv)..."
...
colcon build --packages-ignore brainco_control jaka_k1_dual_control
